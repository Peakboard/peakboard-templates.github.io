...
description: 
  ...
  - All the data collected through the touchscreen is stored and persisted in a list in Peakboard Hub. This allows you to use the data not only for a real-time overview, but also for historical analysis. The long-term analysis can be performed either via <a href="https://templates.peakboard.com/Overview-Quality-Control/en"> this </a> dashboard or using a BI tool such as Power BI, Tableau or Click.
